...
<div class="container">
        <h2 class="text-center pt-4" style="color : white; background-color:#32383e;">DELETE A USER</h2>
        <br>
            <div class="row">
                <div class="col">
                ...
                ?>
                    <tr style="color : black;">
                        ...
                        <td><a href="removeuserrq.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn btn-dark" style="border-radius:0%;">Remove</button></a></td> 
                    </tr>
                <?php
                        $cnt=$cnt+1;
                    }
